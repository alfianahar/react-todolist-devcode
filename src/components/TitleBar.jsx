                ...
                {path == false ?
                    ...
                    : <>
                        <div className='inline-flex items-center gap-3 lg:gap-4'>
                            <Link to={`/`}>
                                <i class='bx bxs-chevron-left bx-md bx-fade-left-hover'></i>
                            </Link>
                            {/* <input
                                type="text"
                                id="item-title"
                            ...
                            /> */}
                            <h1 class="font-bold text-2xl lg:text-3xl cursor-pointer"
                                data-cy="todo-title"
                            >
                                lala
                            </h1>
                        ...
                        <div className='inline-flex items-center gap-3 lg:gap-4'>
                            ...
                            <div className="dropdown">
                                ...
                                <ul tabIndex={0} className="dropdown-content menu shadow bg-base-100 rounded-md w-52">
                                    <li><a><i class='bx bx-sort-down'></i>Terbaru</a></li>
                                    <li><a><i class='bx bx-sort-up'></i>Terlama</a></li>
                                    <li><a><i class='bx bx-sort-a-z' ></i>A-Z</a></li>
                                    <li><a><i class='bx bx-sort-z-a' ></i>Z-A</a></li>
                                    <li><a><i class='bx bx-sort-alt-2'></i>Belum Selesai</a></li>
                                </ul>
                            </div>
                            <button
                                className="btn btn-primary gap-2  font-semibold text-base normal-case px-3 lg:px-5"
